...
public class TSPanalysis {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ef.value(rhc.getOptimal()) + " " + fit.getIterations());
        ...
        FixedIterationTrainer fitt = new FixedIterationTrainer(mimic, 1000);
        fitt.train(mimicList, mimicTimes);
        ...
        try {
            Path file = Paths.get("TSPOutputOut.csv");
